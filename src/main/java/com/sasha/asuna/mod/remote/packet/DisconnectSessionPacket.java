...
import com.sasha.asuna.mod.remote.packet.events.DisconnectSessionEvent;
...
public class DisconnectSessionPacket extends Packet.Incoming {
    ...
    public void processIncomingPacket() {
        AsunaMod.logErr(true, "Data server forcefully disconnected us: " + reason);
        GuiCloudLogin.message = reason;
        AsunaMod.REMOTE_DATA_MANAGER.EVENT_MANAGER.invokeEvent(new DisconnectSessionEvent(this));
    }
