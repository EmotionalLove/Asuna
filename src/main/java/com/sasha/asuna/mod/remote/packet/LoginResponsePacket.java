...
public class LoginResponsePacket extends Packet.Incoming {
    ...
    private String asunaSessionId; // this is NOT your mojang session id, this is generated by the Asuna response server and is as a verification token.
    ...
    public void processIncomingPacket() {
        ...
        if (loginSuccessful) {
            AsunaMod.REMOTE_DATA_MANAGER.loggedIn = true;
            AsunaMod.REMOTE_DATA_MANAGER.asunaSessionId = this.asunaSessionId;
    ...
    public String getAsunaSessionId() {
        return asunaSessionId;
    }
