...
import static com.sasha.asuna.mod.AsunaMod.*;
...
public class HelpCommand extends SimpleCommand {
    ...
    public void onCommand() {
        if (this.getArguments() == null) {
            ...
            AsunaMod.COMMAND_PROCESSOR.getCommandRegistry().forEach((clazz, ins) -> {
        ...
        if (this.getArguments()[0].toLowerCase().matches("feature|module")) {
            for (IAsunaFeature module : Manager.Feature.featureRegistry) {
