 ...
 */
public class AsunaBatteryLevelChangedEvent extends SimpleEvent {

    private int oldBatteryPercent;
    private int newBatteryPercent;
    private boolean isCharging;

    public AsunaBatteryLevelChangedEvent(int oldBatteryPercent, int newBatteryPercent, boolean isCharging) {
