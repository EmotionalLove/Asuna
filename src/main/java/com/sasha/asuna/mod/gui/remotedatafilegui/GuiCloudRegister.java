...
import com.sasha.asuna.mod.remote.packet.AttemptRegisterPacket;
...
public class GuiCloudRegister extends GuiScreen {
    ...
    public void initGui() {
        ...
        GuiCloudLogin.message = "fCreate a new Asuna Cloud account.";
    }
    ...
    public void actionPerformed(GuiButton button) {
        switch (button.id) {
            case 1:
                ...
                AttemptRegisterPacket pck = new AttemptRegisterPacket(AsunaDataClient.processor);
