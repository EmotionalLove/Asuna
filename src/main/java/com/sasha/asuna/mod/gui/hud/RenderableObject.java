...
public abstract class RenderableObject {
    ...
    @Transient private IAsunaFeature tiedFeature;


    public RenderableObject(String name, ScreenCornerPos defaultPos, IAsunaFeature feature) {
        this.name = name;
     ...
     */
    public RenderableObject(String name, @Nullable String pos, ScreenCornerPos defaultPos, IAsunaFeature feature) {
        this.name = name;
        this.defaultPos = defaultPos;
        this.tiedFeature = feature;
        if (pos == null) {
    ...
    @Deprecated
    public RenderableObject(String name, IAsunaFeature feature) {
        this.name = name;
        this.tiedFeature = feature;
    }
    ...
    protected boolean shouldRender() {
        if (this.tiedFeature instanceof IAsunaTogglableFeature) {
            return ((IAsunaTogglableFeature) this.tiedFeature).isEnabled();
        }
        return true;
    }
