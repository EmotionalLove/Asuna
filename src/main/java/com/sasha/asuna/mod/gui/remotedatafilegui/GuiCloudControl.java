...
package com.sasha.asuna.mod.gui.remotedatafilegui;

import com.sasha.asuna.mod.AsunaMod;
import com.sasha.asuna.mod.remote.AsunaDataClient;
import com.sasha.asuna.mod.remote.packet.RequestSaveDataFilePacket;
import com.sasha.asuna.mod.remote.packet.RetrieveDataFileRequestPacket;
...
import static com.sasha.asuna.mod.gui.remotedatafilegui.GuiCloudLogin.message;
...
public class GuiCloudControl extends GuiScreen {
    ...
    public void actionPerformed(GuiButton button) {
        switch (button.id) {
            case 1:
                RetrieveDataFileRequestPacket pck = new RetrieveDataFileRequestPacket(AsunaDataClient.processor, AsunaMod.REMOTE_DATA_MANAGER.asunaSessionId);
                pck.dispatchPck();
                message = "bRetrieving the data file...";
                break;
            case 2:
                RequestSaveDataFilePacket ssdfp = new RequestSaveDataFilePacket(AsunaDataClient.processor, AsunaMod.REMOTE_DATA_MANAGER.asunaSessionId);
                ssdfp.dispatchPck();
