...
public class AsunaGuiField implements IAsunaGuiElement {
    ...
    private void drawEditing() {
        AsunaMath.drawRect(this.x, this.y,
                ...
                145f, 255f, 158f, 50f);
        if (cursorTicker > 500) {
            AsunaMod.FONT_MANAGER.segoe_36.drawCenteredString("_", (this.x + (this.width / 2)) + AsunaMod.FONT_MANAGER.segoe_36.getStringWidth(text), this.y + (((this.y + this.height) - this.y) / 4), 0xfffff);
        }
    }
