...
import com.sasha.asuna.mod.remote.packet.AttemptLoginPacket;
...
public class GuiCloudLogin extends GuiScreen {
    ...
    public void initGui() {
        ...
        if (!previouslyConnected) {
            AsunaMod.REMOTE_DATA_MANAGER.connect();
            previouslyConnected = true;
        }
        AsunaMod.REMOTE_DATA_MANAGER.loggedIn = false;
        message = "fUse your Asuna Cloud credentials to log in, or, create an account";
    }
    ...
    public void actionPerformed(GuiButton button) {
        switch (button.id) {
            case 1:
                ...
                AttemptLoginPacket pck = new AttemptLoginPacket(AsunaDataClient.processor);
    ...
    public void drawScreen(int x, int y, float f) {
        if (AsunaMod.REMOTE_DATA_MANAGER.loggedIn) {
