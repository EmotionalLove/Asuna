...
public class WaypointSearch {
    ...
    public static void buttonUpdate(String term) {
        ...
        for (Waypoint wp : AsunaMod.WAYPOINT_MANAGER.getWaypoints()) {
    ...
    public void draw() {
        ...
        //currentText=initText;
        AsunaMath.drawBetterBorderedRect(x + window.getDragX(), y + window.getDragY(), x + 196 + window.getDragX(), y + 12 + window.getDragY(), 0.5F, var1, var2, var3, var4, 1f, 1f, 1f, varia);
        ...
        AsunaMod.FONT_MANAGER.segoe_30.drawStringWithShadow(currentText, (x + 4 + window.getDragX()), (int) y + window.getDragY(), 0xFFFFFF);
