 ...
 **/
public abstract class AdorufuCommand {
//todo
    ...
    public AdorufuCommand(String commandName){
    ...
    public String[] getSyntax(Class<?> clazz){
        ...
        if (d == null){
            throw new AdorufuCommandAnnotationException("The developer didn't decorate " + this.getClass().getName() + " with a CommandInfo annotation!");
        }
        return d.syntax();
    }
