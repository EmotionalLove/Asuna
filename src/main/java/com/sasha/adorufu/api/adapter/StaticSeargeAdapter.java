...
public class StaticSeargeAdapter {
    ...
    /**
     * Finds specific static-methods based on the parameters you specify and their types. In generic cases where a class may have
     ...
     */
    @Nullable
    public List<Method> findStaticFunc(Object... args) {
    ...
    @Nullable
    public Object invokeStatic(Method func, Object... args) {
