 ...
 **/
public class XdolfModuleTogglePreEvent extends SimpleCancellableEvent {
    private XdolfModule toggledModule;
    private ModuleState toggleState;

    public XdolfModuleTogglePreEvent(XdolfModule toggledModule, ModuleState toggleState){
